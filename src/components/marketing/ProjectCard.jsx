...
export function ProjectCard({ title, meta, image, imageAlt, href = "#", onClick, style, priority }) {
  return (
    <m.a className="ah-projectcard" href={href} onClick={onClick} style={style} whileTap={tap} transition={tapTransition}>
      <img className="ah-projectcard__img" src={image} alt={imageAlt || title} {...(priority ? { fetchpriority: "high" } : {})} />
